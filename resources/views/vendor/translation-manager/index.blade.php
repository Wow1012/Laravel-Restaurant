...
<body>
<?php /* <header class="navbar navbar-static-top navbar-inverse" id="top" role="banner">
...
<div class="container-fluid">
    ...
    <?php if($group): ?>
        <form style="display:none" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postAdd', array($group)) ?>" method="POST"  role="form">
            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
            <div class="form-group">
