...
<div class="ibox-content">
            ...
            <thead>
                <tr>
                    ...
                    <th width="15%">@lang('common.title')</th>
                    <th width="70%">@lang('Tables')</th>
                    <th width="15%">@lang('common.options')</th>
                </tr>
            </thead>
            <tbody>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" action="<?php echo url("rooms/save"); ?>" method="post" enctype="multipart/form-data">
